...
# 4. Package environment state into a tuple format for SARSA
# 5. Visualizations
...
class GridEnvironment:
    ...
    def reset(self):
        ...
        self.spawn_tokens(11) #initially 11 tokens in the grid
        ...
        def step(self, agent_action, is_chase_phase=False):
            ...
            if self.agent_pos == self.threat_pos and self.agent_pos!=self.safe_zone:
                ...
                return "CAUGHT", self.rewards["is_caught"]
